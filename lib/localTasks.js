  ...
  getAppSrc = module.exports = {
    initPM2MeteorSettings: function(done) {
      ...
      return p.then(function(answers) {
        ...
        host = answers.serverHost, username = answers.serverUsername, password = answers.serverPassword, pem = answers.serverPem, instances = answers.serverInstances;
    ...
    generatePM2EnvironmentSettings: function(pm2mConf, done) {
      var appJson, envJson, err, i, meteorSettingsLocation, meteorSettingsObj, prettyJson, ref, results;
