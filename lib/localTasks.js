  ...
  getAppSrc = module.exports = {
    initPM2MeteorSettings: function(done) {
      ...
      return p.then(function(answers) {
        var MONGO_URL, PORT, ROOT_URL, appLocation, appName, err, host, instances, meteorBuildFlags, meteorSettingsLocation, password, prettyJson, username;
        appName = answers.appName, appLocation = answers.appLocation, meteorSettingsLocation = answers.meteorSettingsLocation, meteorBuildFlags = answers.meteorBuildFlags;
        ROOT_URL = answers.rootURL, PORT = answers.port, MONGO_URL = answers.mongoURL;
        host = answers.serverHost, username = answers.serverUsername, password = answers.serverPassword, instances = answers.serverInstances;
        json = Object.assign(json, {
          appName: appName,
          appLocation: appLocation,
          meteorSettingsLocation: meteorSettingsLocation,
          meteorBuildFlags: meteorBuildFlags
        });
        json.env = Object.assign(json.env, {
          ROOT_URL: ROOT_URL,
          PORT: PORT,
          MONGO_URL: MONGO_URL
        });
