...
(function() {
  ...
  module.exports = {
    ...
    deploy: function(reconfig) {
      ...
      return async.series([
        function(cb) {
          return remoteTasks.checkDeps(session,
        pm2mConf,
        cb);
        },
        function(cb) {
          return remoteTasks.prepareHost(session,
        pm2mConf,
        cb);
        },
        function(cb) {
          return localTasks.generatePM2EnvironmentSettings(pm2mConf,
        cb);
        },
        function(cb) {
          return localTasks.bundleApplication(pm2mConf,
        cb);
        },
        function(cb) {
          return remoteTasks.backupLastTar(session,
        pm2mConf,
        cb);
        },
        function(cb) {
          return remoteTasks.shipTarBall(session,
        pm2mConf,
        cb);
        },
        function(cb) {
          return remoteTasks.extractTarBall(session,
        pm2mConf,
        cb);
        },
        function(cb) {
          return remoteTasks.installBundleDeps(session,
        pm2mConf,
        cb);
        },
        function(cb) {
          return remoteTasks.runRemoteScript(session,
        pm2mConf,
        cb);
        },
        function(cb) {
          return remoteTasks.reloadApp(session,
        pm2mConf,
        reconfig,
        cb);
        }
    ...
    reconfig: function() {
      ...
      return async.series([
        ...
        function(cb) {
          return remoteTasks.shipSettings(session,
        pm2mConf,
        cb);
        },
        function(cb) {
    ...
    start: function() {
      ...
      return async.series([
        function(cb) {
          return remoteTasks.startApp(session,
        pm2mConf,
        cb);
        }
      ], function(err) {
    ...
    stop: function() {
      ...
      return async.series([
        function(cb) {
          return remoteTasks.stopApp(session,
        pm2mConf,
        cb);
        }
      ], function(err) {
    ...
    status: function() {
      ...
      return async.series([
        function(cb) {
          return remoteTasks.status(session,
        pm2mConf,
        cb);
        }
      ], function(err, result) {
    ...
    undeploy: function() {
      ...
      return async.series([
        function(cb) {
          return remoteTasks.killApp(session,
        pm2mConf,
        cb);
        },
        function(cb) {
          return remoteTasks.deleteAppFolder(session,
        pm2mConf,
        cb);
        }
      ], function(err) {
    ...
    scale: function(opts) {
      ...
      return async.series([
        function(cb) {
          return remoteTasks.scaleApp(session,
        pm2mConf,
        opts,
        cb);
        }
    ...
    logs: function() {
      ...
      return async.series([
        function(cb) {
          return remoteTasks.getAppLogs(session,
        pm2mConf,
        cb);
        }
      ], function(err) {
    ...
    revert: function() {
      ...
      return async.series([
        function(cb) {
          return remoteTasks.revertToBackup(session,
        pm2mConf,
        cb);
        },
        function(cb) {
