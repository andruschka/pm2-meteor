...
(function() {
  ...
  module.exports = {
    ...
    deploy: function() {
      ...
      return async.series([
        ...
        if (err) {
          ...
          return cli.spinner("Deployed your app on the host machine!", true);
        }
      });
    },
    start: function() {
    ...
    generateEnvFile: function() {
      ...
      pm2mConf = commonTasks.readPM2MeteorConfig();
      return localTasks.generatePM2EnvironmentSettings(pm2mConf, function(err) {
        if (err) {
          cli.pinner("Oh oh.", true);
          return cli.fatal("" + err.message);
        } else {
          return cli.spinner("Generated " + _settings.pm2EnvConfigName + "!");
        }
      });
    }
  };
