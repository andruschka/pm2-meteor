...
(function() {
  ...
  module.exports = {
    getRemoteSession: function(pm2mConf) {
      var session, sshConfig;
      sshConfig = {};
      if (pm2mConf.server.port) {
        sshConfig.port = pm2mConf.server.port;
      }
      if (pm2mConf.server.ssh) {
        sshConfig = sshConfig ? _extends({}, sshConfig, pm2mConf.server.ssh) : pm2mConf.server.ssh;
      }
    ...
    reloadApp: function(session, pm2mConf, reconfig, cold, done) {
      if (cold) {
